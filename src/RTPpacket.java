...
public class RTPpacket{
  ...
  public RTPpacket(int PType, int Framenb, int Time, byte[] data, int data_length){
    ...
    header[3] = (byte) (header[2] | (SequenceNumber >> 0));
    header[4] = (byte) (header[4] | (TimeStamp >> 24));
    header[5] = (byte) (header[5] | (TimeStamp >> 16));
    header[6] = (byte) (header[6] | (TimeStamp >> 8));
    header[7] = (byte) (header[7] | (TimeStamp >> 0));
    header[8] = (byte) (header[8] | (Ssrc >> 24));
    header[9] = (byte) (header[9] | (Ssrc >> 16));
    header[10] = (byte) (header[10] | (Ssrc >> 8));
    ...
    //......
    payload = Arrays.copyOfRange(data, 0, payload_size);
